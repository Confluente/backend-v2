...
export class RoleWeb extends AbstractWebModel {
    ...
    public getCopyable(): string[] {
        return ["id", "name", "PARTNER_MANAGE", "PARTNER_VIEW", "PAGE_VIEW", "PAGE_MANAGE", "USER_CREATE", "USER_VIEW_ALL", "USER_MANAGE", "CHANGE_ALL_PASSWORDS", "ROLE_VIEW", "ROLE_MANAGE", "GROUP_VIEW", "GROUP_MANAGE", "GROUP_ORGANIZE_WITH_ALL", "ACTIVITY_VIEW_PUBLISHED", "ACTIVITY_VIEW_ALL_UNPUBLISHED", "ACTIVITY_MANAGE"];
    }
}
